...
As described in \chapref{chap:Introduction} the proposed method of this study is to calculate confidence scores to use as a mean of providing user feedback. This will be made possible by implementing LDA as a linear classifier to enable both a classification based control scheme and to be able to calculate confidence scores to use as feedback in user training. 
