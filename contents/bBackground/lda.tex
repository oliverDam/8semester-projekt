...
Often regions are contiguous and will have a single boundary to separate several regions. \cite{Duda2000} An illustration of this can be seen on \figref{fig:LMregions}. 
