...
\begin{figure}[H] 
	\centering
	\subfigure[Overshoot metric for the Fitts' Law test between the test and control group.]
	{\includegraphics[width=.49\textwidth]{figures/xWesulds/Overshoot}}
	\subfigure[Stopping distance metric for the Fitts' Law test between the test and control group.]
