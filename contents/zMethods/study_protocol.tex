...
Exposing subjects to user training in which estimation uncertainty of movement is used as feedback, will show improvement in performance in a classification-based myoelectric prosthetic control scheme.% across short training sessions. 
